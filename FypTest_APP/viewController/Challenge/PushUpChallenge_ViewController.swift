//
//  PushUpChallenge_ViewController.swift
//  FypTest_APP
//
...
import Firebase
import FirebaseAuth
class PushUpChallenge_ViewController: UIViewController {
    
    let pushUp_VideoCapture = PushUp_VideoCapture()
    ...
    private let iconImage: UIImageView = {
        ...
        iconimage.image = UIImage(named: "Icon_110_Chest")
        return iconimage}()
    ...
    override func viewDidLoad() {
        ...
        setupVideoPreview()
        //pose detection
        pushUp_VideoCapture.chestChallenge.delegate = self
    }
    ...
    private func setupVideoPreview(){
        pushUp_VideoCapture.startCaptureSession()
        previewLayer = AVCaptureVideoPreviewLayer(session: pushUp_VideoCapture.captureSession)
...
extension PushUpChallenge_ViewController: Chest_ChallengeDelegte{
    ...
    func Chest_Challenge(chest_Challenge_predictor: Chest_Predictor, didFindNewRecognizedPoints point: [CGPoint]) {
