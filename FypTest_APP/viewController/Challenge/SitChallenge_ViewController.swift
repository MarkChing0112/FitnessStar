//
//  SitChallenge_ViewController.swift
//  FypTest_APP
//
...
import Firebase
import FirebaseAuth
class SitChallenge_ViewController: UIViewController {
    
    let sit_VideoCapture = Sit_VideoCapture()
    ...
    override func viewDidLoad() {
        ...
        setupVideoPreview()
        //pose detection
        sit_VideoCapture.Sit_Challenge.delegate = self
    }
    ...
    private func setupVideoPreview(){
        sit_VideoCapture.startCaptureSession()
        previewLayer = AVCaptureVideoPreviewLayer(session: sit_VideoCapture.captureSession)
...
extension SitChallenge_ViewController: Sit_ChallengeDelegte{
    func Sit_Challenge(sit_Challenge_predictor: Sit_Predictor, didLableAction action: String, with confience: Double) {
    ...
    func Sit_Challenge(sit_Challenge_predictor: Sit_Predictor, didFindNewRecognizedPoints point: [CGPoint]) {
