...
class StandTraining_Predictor {
    
    weak var  delegate: StandTrainingDelegte?
    ...
    func  labelActionType(){
        ...
        delegate?.StandTraining(standTraining_predictor: self, didLableAction: label, with: confience)
    ...
    func processObservation( observation: VNHumanBodyPoseObservation){
         do{
            ...
            delegate?.StandTraining(standTraining_predictor: self, didFindNewRecognizedPoints: displayPoints)
        }
         catch {
