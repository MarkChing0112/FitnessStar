//
//  PushUpTraining_ViewController.swift
//  FypTest_APP
//
...
class PushUpTraining_ViewController: UIViewController {
    let pushUpTraining_videoCapture = PushUpTraining_VideoCapture()
    ...
    override func viewDidLoad() {
        ...
        setupVideoPreview()
        //pose detection
        pushUpTraining_videoCapture.pushUpTraining_Predictor.delegate = self
    }
    ...
    private func setupVideoPreview(){
        pushUpTraining_videoCapture.startCaptureSession()
        previewLayer = AVCaptureVideoPreviewLayer(session: pushUpTraining_videoCapture.captureSession)
...
extension PushUpTraining_ViewController: PushUpTrainingDelegte{
